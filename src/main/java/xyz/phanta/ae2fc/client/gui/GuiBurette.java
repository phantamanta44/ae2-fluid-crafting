...
public class GuiBurette extends AEBaseGui {
    ...
    private static final ResourceLocation TEX_BG = Ae2FluidCrafting.resource("textures/gui/burette.png");
        ...
        return new ButtonMouseHandler(into ? NameConst.TT_TRANSPOSE_IN : NameConst.TT_TRANSPOSE_OUT, () -> {
            try {
                ...
                if (cont.canTranferFluid(into)) {
                    Ae2FluidCrafting.PROXY.getNetHandler().sendToServer(new CPacketTransposeFluid(amount, into));
                }
